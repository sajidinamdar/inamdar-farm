...
const FarmDetailsPage = () => {
  ...
  const handleWhatsAppInquiry = () => {
    ...
    const url = `https://wa.me/91${OWNER_DETAILS.contact.phone}?text=${encodeURIComponent(message)}`;
    window.open(url, '_blank');
  };

  const handleEmailInquiry = () => {
    const subject = `इनामदार फार्म्स - शेत चौकशी: ${farm.title} (ID: ${farm.id})`;
    const body = `नमस्कार इनामदार सर,%0D%0A%0D%0Aमला खालील शेत बद्दल अधिक माहिती हवी आहे:%0D%0A%0D%0Aशेत नाव: ${farm.title}%0D%0AID: ${farm.id}%0D%0Aस्थान: ${farm.location}%0D%0Aआकार: ${farm.size} एकर%0D%0Aकिंमत: ${farm.price}%0D%0A%0D%0Aकृपया तपशीलवार माहिती पाठवा.%0D%0A%0D%0Aधन्यवाद`;
    window.location.href = `mailto:${OWNER_DETAILS.contact.email}?subject=${subject}&body=${body}`;
  };
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                ...
                <button 
                   ...
                   className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition shadow-lg hover:shadow-blue-200"
                >
                ...
                <a 
                   href={`tel:+91${OWNER_DETAILS.contact.phone}`}
